...
const Active = () => {
    ...
    return (
        <DashboardLayout title="Dashboard" slug="LOAD STATION">
                    ...
                    <div className="flex w-1/2 bg-gray13 rounded-xl">
                        <div className="flex flex-row gap-2">
                            <div className="flex flex-col p-4 gap-4">
                                <FormField name="userId" label="Load to" placeholder="Enter User ID" value={userInput} onChange={(e) => { setUserInput(e.target.value) }} customLabelClass="text-xs" />
