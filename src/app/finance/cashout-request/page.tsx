...
const FundingRequest = () => {
    ...
    const getFundingRequests = async () => {
        try {
            ...
            const response = await localAxios.get('/api/get-cashout-requests',)
    ...
    const onConfirmAction = async () => {
        ...
        try {
            ...
            let response
            if (action === 'APPROVE') {
                response = await localAxios.post('/api/approve-cashout', {
                    id: funding
                })
            } else {
                response = await localAxios.post('/api/reject-cashout', {
                    id: funding
                })
            }
    ...
    return (
        <div className="flex flex-col w-full" key={`agentList-${index}`}>
            ...
            <div className="flex flex-col gap-4 w-full overflow-auto pr-4">
                {/* <BalanceBar rigthElement='Cashout Request Menu' balance={balance} /> */}
